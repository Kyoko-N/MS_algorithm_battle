...
def run(inputData):
    ...
    maxMoney = 0
    output = []
    for cutPoint in range(300,500,1):

        bestA = CalculateBestStrategyFrom(A, 'A', 0)
        bestB = CalculateBestStrategyFrom(B, 'B', 0)
        bestC = CalculateBestStrategyFrom(C, 'C', 0)
